...
%% General Setup
bemobil_config.study_folder = ['/Users/maltedrees/Desktop/example' filesep 'data' filesep]; %(NEEDS to have a filesep at the end, sorry!) 
bemobil_config.filename_prefix = 'sub-S';
...
% filenames
% EEG
bemobil_config.merged_filename = 'task-task_eeg.set';
...
bemobil_config.resample_freq = 512; 
